...
class JsonWebToken extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JsonWebToken', createEmptyInstance: create)
  ...
  factory JsonWebToken.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory JsonWebToken.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  JsonWebToken copyWith(void Function(JsonWebToken) updates) => super.copyWith((message) => updates(message as JsonWebToken)) as JsonWebToken; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static JsonWebToken create() => JsonWebToken._();
  JsonWebToken createEmptyInstance() => create();
  static $pb.PbList<JsonWebToken> createRepeated() => $pb.PbList<JsonWebToken>();
  @$core.pragma('dart2js:noInline')
  static JsonWebToken getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<JsonWebToken>(create);
...
class SignInRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignInRequest', createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'digitalSignature', $pb.PbFieldType.OY, protoName: 'digitalSignature')
    ..hasRequiredFields = false
  ;
  ...
  factory SignInRequest({
    ...
    $core.List<$core.int>? digitalSignature,
  }) {
    final _result = create();
    if (publicKey != null) {
  ...
  @$pb.TagNumber(2)
  set digitalSignature($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
